                        ...
                        <div class="flex items-start space-x-4">
                            <div class="relative">
                                ...
                                <img src="{{ $friend->image ?? 'https://i.pravatar.cc/150?u=' . $friend->id }}"
                                    alt="{{ $friend->nom }}"
                                    class="w-12 h-12 rounded-full object-cover ring-2 ring-offset-2 {{ $isSelected ? 'ring-indigo-500' : 'ring-gray-100 group-hover:ring-indigo-200' }} transition-all">
                            ...
                            <div class="flex-1 min-w-0 py-1">
                                ...
                                <div
                                    class="text-sm {{ $isSelected ? 'text-indigo-600' : 'text-gray-500' }} font-medium truncate">
            ...
            @if($selected_user)
                <div class="px-6 py-3 border-b border-gray-200 bg-white shadow-sm z-10 flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative">
                            <img src="{{$selected_user->image }}" alt="{{ $selected_user->prenom  }}"
