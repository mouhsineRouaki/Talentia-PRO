                ...
                <div class="relative px-6 pb-8">
                    ...
                    <div class="space-y-2">
                        ...
                        @if($plan === 'Professional')
                            <span class="ml-2 inline-flex items-center rounded-full px-3 py-1 text-[11px] font-black uppercase tracking-wider ring-1 bg-amber-50 text-amber-700 ring-amber-200">
                                <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
                                PRO
                            </span>
                        @elseif($plan === 'Business')
                            <span class="ml-2 inline-flex items-center rounded-full px-3 py-1 text-[11px] font-black uppercase tracking-wider ring-1 bg-slate-800 text-white ring-slate-600">
                        ...
                        @elseif($user->subscribed('default'))
                             <span class="ml-2 inline-flex items-center rounded-full px-3 py-1 text-[11px] font-black uppercase tracking-wider ring-1 bg-indigo-100 text-indigo-800 ring-indigo-200">
                                PRO
                            </span>
                        @endif
                    </div>
